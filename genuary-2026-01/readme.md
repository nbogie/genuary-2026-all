...
I'm really just here to test out my typescript template. Didn't have any good ideas for the prompt, so I'll practice recursion and try to draw a tree with a single rectangle shape, scaled uniformly.

# original template docs - p5 v2.x typescript project starter (global/instance mode)

This project was set up by making a copy of this template: https://github.com/nbogie/p5-v2-ts-global-mode-starter

...perhaps with degit like this `npx degit nbogie/p5-v2-ts-global-mode-starter`
